...
(() => {
  ...
  const TOOLS = [
    ...
    {
      name: "reshapeClip",
      description: "Change where an existing clip starts or ends, by naming the words rather than guessing seconds. Use it when the human says something like 'start it from where they say the phone rings' — far more reliable than nudging with trimClip until it sounds right.",
      annotations: { readOnlyHint: false },
      inputSchema: {
        type: "object",
        properties: {
